	...
	if instance_exists(lvl_one){
	  ...
	  //if place_meeting(x-150,y, Player_Knight)	{
		  ...
		  if BossCorrect = 0 or BossCorrect = 1	{
			...
			textbox_add_options(c_red, 0,"a) To learn", "b) To have fun and party", "c) Compete in events testing their skills");
			//What happens with whatever you choose
			textbox_change_message_according_option(1, 1, "Almost, not quite", "Wrong", "You are correct!");
			...
			textbox_add_options(c_red, 0,"a) To impress your peers", "b)  Skills useful in leadership and career development", "c) To show off your style and what you own");
